...
<Button label="Check Requirements" link="/financial-solutions/wells-fargo-autograph-card-requirements" />
...
<Button label="View Application Requirements" link="/financial-solutions/wells-fargo-autograph-card-requirements" />
